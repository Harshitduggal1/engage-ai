        ...
        <div className="flex justify-end items-center lg:hidden">
            <Sheet open={isOpen} onOpenChange={setIsOpen}>
                ...
                <SheetContent className="w-screen">
                    <SheetClose asChild className="top-3 right-5 z-20 absolute flex justify-center items-center bg-background">
                        <Button size="icon" variant="ghost" className="text-neutral-600">
                            <X className="w-5 h-5" />
                        </Button>
                    </SheetClose>
                    <div className="flex flex-col items-start mt-10 py-2 w-full">
                                    ...
                                    <AccordionItem key={link.title} value={link.title} className="last:border-none">
                                        {link.menu ? (
                                            ...
                                            <Link
                                                href={link.href}
                                                onClick={handleClose}
                                                className="flex items-center py-4 w-full font-medium text-muted-foreground hover:text-foreground"
                                            >
